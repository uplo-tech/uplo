...
// unmarshalUplo decodes the Skykey into the reader.
func (skOld *compatSkykeyV148) unmarshalUplo(r io.Reader) error {
...
// marshalUplo encodes the Skykey into the writer.
func (skOld compatSkykeyV148) marshalUplo(w io.Writer) error {
...
func (skOld *compatSkykeyV148) fromString(s string) error {
	...
	return skOld.unmarshalUplo(bytes.NewReader(keyBytes))
}
...
func (skOld compatSkykeyV148) convertToUpdatedFormat() (Skykey, error) {
	...
	_, err := crypto.NewUploKey(sk.CipherType(), sk.Entropy)
	if err != nil {
...
func (sk *Skykey) unmarshalAndConvertFromOldFormat(r io.Reader) error {
	...
	err := oldFormatSkykey.unmarshalUplo(r)
	if err != nil {
		return err
	}
...
// unmarshalUplo decodes the Skykey data and name into the reader.
func (sk *Skykey) unmarshalUplo(r io.Reader) error {
...
// marshalUplo encodes the Skykey data and name into the writer.
func (sk Skykey) marshalUplo(w io.Writer) error {
...
func (sk *Skykey) SubkeyWithNonce(nonce []byte) (Skykey, error) {
	...
	// Sanity check that we can actually make a CipherKey with this.
	_, err := crypto.NewUploKey(sk.CipherType(), entropy)
	if err != nil {
...
func (sk *Skykey) CipherKey() (crypto.CipherKey, error) {
	return crypto.NewUploKey(sk.CipherType(), sk.Entropy)
}
