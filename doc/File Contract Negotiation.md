...
Securing data on Uplo requires creating and revising file contracts in an
untrusted environment. Managing data on Uplo happens through several protocols:
...
The renter pays for the uplofund fee on the host's collateral and contract fee.
