...
import (
	...
	"github.com/uplo-tech/merkletree/merkletree-blake"
...
// to assume uplo-specific constants and return uplo-specific types.
...
// definitions to assume uplo-specific constants and return uplo-specific types.
...
// Prove is a redefinition of merkletree.CachedTree.Prove, so that Uplo-specific
