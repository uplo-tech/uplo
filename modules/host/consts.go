...
var (
	...
	// defaultCollateralBudget defines the maximum number of Uplocoins that the
	...
	defaultCollateralBudget = types.UplocoinPrecision.Mul64(100e3)
	...
	defaultMaxEphemeralAccountRisk = types.UplocoinPrecision.Mul64(5)
