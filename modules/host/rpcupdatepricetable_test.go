...
func TestPriceTableMarshaling(t *testing.T) {
	pt := modules.RPCPriceTable{
		...
		UpdatePriceTableCost: types.UplocoinPrecision,
		InitBaseCost:         types.UplocoinPrecision.Mul64(1e2),
		MemoryTimeCost:       types.UplocoinPrecision.Mul64(1e3),
		ReadBaseCost:         types.UplocoinPrecision.Mul64(1e4),
		ReadLengthCost:       types.UplocoinPrecision.Mul64(1e5),
		HasSectorBaseCost:    types.UplocoinPrecision.Mul64(1e6),
		TxnFeeMinRecommended: types.UplocoinPrecision.Mul64(1e7),
		TxnFeeMaxRecommended: types.UplocoinPrecision.Mul64(1e8),
		DropSectorsBaseCost:  types.UplocoinPrecision.Mul64(1e9),
		DropSectorsUnitCost:  types.UplocoinPrecision.Mul64(1e10),
		WriteBaseCost:        types.UplocoinPrecision.Mul64(1e11),
		WriteLengthCost:      types.UplocoinPrecision.Mul64(1e12),
		WriteStoreCost:       types.UplocoinPrecision.Mul64(1e13),
		LatestRevisionCost:   types.UplocoinPrecision.Mul64(1e14),
		FundAccountCost:      types.UplocoinPrecision.Mul64(1e15),
		AccountBalanceCost:   types.UplocoinPrecision.Mul64(1e16),
		SwapSectorCost:       types.UplocoinPrecision.Mul64(1e17),
	}
