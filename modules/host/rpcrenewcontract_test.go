...
func TestVerifyRenewedContract(t *testing.T) {
	...
	pt := &modules.RPCPriceTable{
		...
		MaxCollateral:     types.UplocoinPrecision.Mul64(100),
		ContractPrice:     types.UplocoinPrecision,
		MaxDuration:       100,
		WriteStoreCost:    types.NewCurrency64(1),
		WindowSize:        10,
		RenewContractCost: types.UplocoinPrecision,
	}
	...
	oldRevision := types.FileContractRevision{
		...
		NewValidProofOutputs: []types.UplocoinOutput{
			{
				...
				Value:      types.UplocoinPrecision.Mul64(10),
			},
			{
				UnlockHash: types.UnlockHash{2},
				Value:      types.UplocoinPrecision.Mul64(20),
			},
		},
		NewMissedProofOutputs: []types.UplocoinOutput{
			...
			{
				UnlockHash: types.UnlockHash{2},
				Value:      types.UplocoinPrecision.Mul64(20).Sub64(1),
			},
			{
	...
	goodFC := fc
	goodFC.ValidProofOutputs = append([]types.UplocoinOutput{}, goodFC.ValidProofOutputs...)
	...
	badFC = fc
	badFC.ValidProofOutputs = append([]types.UplocoinOutput{}, badFC.ValidProofOutputs...)
	...
	badFC = fc
	badFC.MissedProofOutputs = append([]types.UplocoinOutput{}, badFC.MissedProofOutputs...)
	...
	goodFC = fc
	goodFC.ValidProofOutputs = append([]types.UplocoinOutput{}, goodFC.ValidProofOutputs...)
	goodFC.MissedProofOutputs = append([]types.UplocoinOutput{}, goodFC.MissedProofOutputs...)
