...
// track of running values.
func (v *TestValues) AddUpdateRegistryInstruction(spk types.UploPublicKey, rv modules.SignedRegistryValue) {
...
// track of running values.
func (v *TestValues) AddReadRegistryInstruction(spk types.UploPublicKey, refunded bool) {
