...
func (tb *testProgramBuilder) AddUpdateRegistryInstruction(spk types.UploPublicKey, rv modules.SignedRegistryValue) {
...
// builder, keeping track of running values.
func (tb *testProgramBuilder) AddReadRegistryInstruction(spk types.UploPublicKey, tweak crypto.Hash, refunded bool) types.Currency {
