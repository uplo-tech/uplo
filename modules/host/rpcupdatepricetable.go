...
func (h *Host) managedRPCUpdatePriceTable(stream uplomux.Stream) (err error) {
...
func (h *Host) staticReadPriceTableID(stream uplomux.Stream) (*modules.RPCPriceTable, error) {
