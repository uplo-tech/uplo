...
// tweak.
func valueMapKey(key types.UploPublicKey, tweak crypto.Hash) crypto.Hash {
...
func (r *Registry) Get(pubKey types.UploPublicKey, tweak crypto.Hash) (modules.SignedRegistryValue, bool) {
	r.mu.Lock()
...
func (r *Registry) Update(rv modules.SignedRegistryValue, pubKey types.UploPublicKey, expiry types.BlockHeight) (srv modules.SignedRegistryValue, _ error) {
...
func (r *Registry) newValue(rv modules.SignedRegistryValue, pubKey types.UploPublicKey, expiry types.BlockHeight) (*value, error) {
