...
//		There are plans to add newer, faster signature algorithms to Uplo as the
...
//		The arbitrary data field can be used to orchestrate soft-forks to Uplo
...
func isStandardTransaction(t types.Transaction) (uint64, error) {
	...
	// prefixes. The allowed prefixes include a 'NonUplo' prefix for truly
