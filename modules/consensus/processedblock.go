...
type processedBlock struct {
	...
	DiffsGenerated            bool
	UplocoinOutputDiffs        []modules.UplocoinOutputDiff
	FileContractDiffs         []modules.FileContractDiff
	UplofundOutputDiffs        []modules.UplofundOutputDiff
	DelayedUplocoinOutputDiffs []modules.DelayedUplocoinOutputDiff
	UplofundPoolDiffs          []modules.UplofundPoolDiff
