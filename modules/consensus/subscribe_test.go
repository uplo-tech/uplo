...
func TestPerBlockDiffs(t *testing.T) {
	...
	for _, cc := range ms.updates {
		...
		for _, diff := range cc.RevertedDiffs {
			ccd.UplocoinOutputDiffs = append(ccd.UplocoinOutputDiffs, diff.UplocoinOutputDiffs...)
			ccd.FileContractDiffs = append(ccd.FileContractDiffs, diff.FileContractDiffs...)
			ccd.UplofundOutputDiffs = append(ccd.UplofundOutputDiffs, diff.UplofundOutputDiffs...)
			ccd.DelayedUplocoinOutputDiffs = append(ccd.DelayedUplocoinOutputDiffs, diff.DelayedUplocoinOutputDiffs...)
			ccd.UplofundPoolDiffs = append(ccd.UplofundPoolDiffs, diff.UplofundPoolDiffs...)
		}
