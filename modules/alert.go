...
// The following consts are a list of AlertIDs. All IDs used throughout Uplo
...
// AlertIDUplofileLowRedundancy uses a Uplofile's UID to create a unique AlertID
// for a low redundancy alert.
func AlertIDUplofileLowRedundancy(uid string) AlertID {
