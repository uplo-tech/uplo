...
// multipart.Reader.
func NewSkyfileMultipartReader(reader *multipart.Reader, fanoutReader *multipart.Reader, sup SkyfileUploadParameters) SkyfileUploadReader {
	return newSkyfileMultipartReader(reader, fanoutReader, sup)
}
...
func NewSkyfileMultipartReaderFromRequest(req *http.Request, sup SkyfileUploadParameters) (SkyfileUploadReader, error) {
	...
	return NewSkyfileMultipartReader(mpr, mprFanout, sup), nil
}
...
// a TeeReader of the underlying io.Reader that was used to create the
// multipart.Reader.
func newSkyfileMultipartReader(reader *multipart.Reader, fanoutReader *multipart.Reader, sup SkyfileUploadParameters) *skyfileMultipartReader {
