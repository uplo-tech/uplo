...
// nebulousAddress is the nebulous address that is used to send Uplocoin to
// Nebulous.
...
type (
	Dependencies interface {
		...
		// Uplocoin to a Nebulous managed Wallet.
...
// NebulousAddress will return an address that can be used to send Uplocoin to a
