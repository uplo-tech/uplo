...
var (
	...
	bucketUplocoinOutputIDs = []byte("UplocoinOutputIDs")
	bucketUplocoinOutputs   = []byte("UplocoinOutputs")
	bucketUplofundOutputIDs = []byte("UplofundOutputIDs")
	bucketUplofundOutputs   = []byte("UplofundOutputs")
