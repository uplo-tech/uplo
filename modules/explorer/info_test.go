...
func TestImmediateBlockFacts(t *testing.T) {
	...
	if !facts.TotalCoins.Equals(types.CalculateNumUplocoins(et.cs.Height())) {
...
func TestFileContractPayoutsMissingProof(t *testing.T) {
	...
	fc := types.FileContract{
		...
		WindowEnd:          windowEnd,
		Payout:             payout,
		ValidProofOutputs:  []types.UplocoinOutput{{Value: types.PostTax(et.cs.Height(), payout)}},
		MissedProofOutputs: []types.UplocoinOutput{{Value: types.PostTax(et.cs.Height(), payout)}},
