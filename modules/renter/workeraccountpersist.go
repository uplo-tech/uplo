...
// we think this is a new account, some previous run on uplod may have created
// the account for us.
//
...
func (am *accountManager) managedOpenAccount(hostKey types.UploPublicKey) (acc *account, err error) {
