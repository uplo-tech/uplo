...
type (
	...
	account struct {
		...
		staticHostKey   types.UploPublicKey
...
func (a *account) ProvidePayment(stream io.Writer, host types.UploPublicKey, rpc types.Specifier, amount types.Currency, refundAccount modules.AccountID, blockHeight types.BlockHeight) error {
