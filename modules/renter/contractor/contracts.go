...
// child contract.
func (c *Contractor) managedContractByPublicKey(pk types.UploPublicKey) (modules.RenterContract, bool) {
	c.mu.RLock()
...
// contract.
func (c *Contractor) ContractByPublicKey(pk types.UploPublicKey) (modules.RenterContract, bool) {
...
func (c *Contractor) ContractUtility(pk types.UploPublicKey) (modules.ContractUtility, bool) {
	c.mu.RLock()
	id, ok := c.pubKeysToContractID[pk.String()]
	c.mu.RUnlock()
	if !ok {
