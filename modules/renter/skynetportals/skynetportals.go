...
// unmarshalObjects unmarshals the uplo encoded objects.
...
func (pe persistEntry) MarshalUplo(w io.Writer) error {
...
func (pe *persistEntry) UnmarshalUplo(r io.Reader) error {
	*pe = persistEntry{}
