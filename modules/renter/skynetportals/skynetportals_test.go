...
// TestMarshalUplo probes the marshalUplo and unmarshalUplo methods
func TestMarshalUplo(t *testing.T) {
	// Test MarshalUplo
	portal := modules.SkynetPortal{
		Address: modules.NetAddress("localhost:8480"),
		Public:  true,
	}
	...
	// Test UnmarshalUplo, portals should unmarshal in the order they were
	// marshalled.
	r := bytes.NewBuffer(buf.Bytes())
	err = pe.UnmarshalUplo(r)
	if err != nil {
		t.Fatal(err)
	}
