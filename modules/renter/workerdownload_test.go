...
func TestCheckDownloadGouging(t *testing.T) {
	...
	minAllowance := modules.Allowance{
		...
		Funds: types.UplocoinPrecision.Mul64(3).Div64(downloadGougingFractionDenom).Sub(oneCurrency),
	...
	minPriceTable := &modules.RPCPriceTable{
		ReadBaseCost:          types.UplocoinPrecision,
		ReadLengthCost:        types.UplocoinPrecision.Div64(modules.StreamDownloadSize),
		DownloadBandwidthCost: types.UplocoinPrecision.Div64(modules.StreamDownloadSize),
	}
