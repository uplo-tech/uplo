...
type (
	...
	// DependencyDisableHostUplomux will disable uplomux in the host.
	DependencyDisableHostUplomux struct {
		modules.ProductionDependencies
	}
...
// Disrupt returns true if the correct string is provided.
func (d *DependencyDisableHostUplomux) Disrupt(s string) bool {
	return s == "DisableHostUplomux"
}
