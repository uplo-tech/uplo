...
func TestEstimateWeight(t *testing.T) {
	...
	is.MinContractPrice = is.MinContractPrice.Add(types.UplocoinPrecision.Mul64(9999999999))
	...
	for i, tester := range sts {
		...
		is.MinContractPrice = types.UplocoinPrecision.Mul64(1000 + (1000 * uint64(i)))
	...
	tests := []struct {
		...
		{types.UplocoinPrecision, 100},
		{types.UplocoinPrecision.Mul64(50), 98},
		{types.UplocoinPrecision.Mul64(2500), 10},
		{types.UplocoinPrecision.Mul64(3000), 1},
		{types.UplocoinPrecision.Mul64(30000), 0.00001},
	}
