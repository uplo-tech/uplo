...
func (c *Client) HostDbFilterModePost(fm modules.FilterMode, hosts []types.UploPublicKey) (err error) {
...
func (c *Client) HostDbHostsGet(pk types.UploPublicKey) (hhg api.HostdbHostsGET, err error) {
