...
func TestCurrencyRoundDown(t *testing.T) {
	// 10,000 is chosen because that's how many uplofunds there usually are.
...
func TestParseCurrency(t *testing.T) {
	tests := []struct {
		...
		{"pU", "", ErrParseCurrencyAmount},
		{"1pU", "1000000000000", nil},
		{"1 pU", "1000000000000", nil},
		{"2nU ", "2000000000000000", nil},
		{"2 nU", "2000000000000000", nil},
		{"0uU", "0", nil},
		{"0 uU", "0", nil},
		{"10mU", "10000000000000000000000", nil},
		{"10 mU", "10000000000000000000000", nil},
		{"2UC", "2000000000000000000000000", nil},
		{"2 UC", "2000000000000000000000000", nil},
		{" 1KU ", "1000000000000000000000000000", nil},
		{"1 KU", "1000000000000000000000000000", nil},
		{"4MU", "4000000000000000000000000000000", nil},
		{"4 MU", "4000000000000000000000000000000", nil},
		{"2GU", "2000000000000000000000000000000000", nil},
		{" 2 GU ", "2000000000000000000000000000000000", nil},
		{"1TU", "1000000000000000000000000000000000000", nil},
		{"1 TU", "1000000000000000000000000000000000000", nil},
		{"0.5TU", "500000000000000000000000000000000000", nil},
		{"0.5 TU", "500000000000000000000000000000000000", nil},
		{"x UC", "", ErrParseCurrencyAmount},
	}
	for _, test := range tests {
