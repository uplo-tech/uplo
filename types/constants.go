...
var (
	...
	UplofundPortion = big.NewRat(39, 1000)
...
func init() {
	if build.Release == "dev" {
		...
		GenesisUplocoinAllocation = []UplocoinOutput{
			{
				Value:      NewCurrency64(10000000).Mul(UplocoinPrecision),
