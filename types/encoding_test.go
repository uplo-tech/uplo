...
func TestCurrencyUnits(t *testing.T) {
	tests := []struct {
		...
		{NewCurrency64(1000000000000), "1 pU"},
		{NewCurrency64(1234560000000), "1.235 pU"},
		{NewCurrency64(12345600000000), "12.35 pU"},
		{NewCurrency64(123456000000000), "123.5 pU"},
		{NewCurrency64(1000000000000000), "1 nU"},
		{NewCurrency64(1000000000000000000), "1 uU"},
		{NewCurrency64(1000000000).Mul64(1000000000000), "1 mU"},
		{NewCurrency64(1).Mul(UplocoinPrecision), "1 UC"},
		{NewCurrency64(1000).Mul(UplocoinPrecision), "1 KU"},
		{NewCurrency64(1000000).Mul(UplocoinPrecision), "1 MU"},
		{NewCurrency64(1000000000).Mul(UplocoinPrecision), "1 GU"},
		{NewCurrency64(1000000000000).Mul(UplocoinPrecision), "1 TU"},
		{NewCurrency64(1234560000000).Mul(UplocoinPrecision), "1.235 TU"},
		{NewCurrency64(1234560000000000).Mul(UplocoinPrecision), "1235 TU"},
	}
