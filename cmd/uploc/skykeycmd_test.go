...
// TestSkykeyCommands tests the basic functionality of the uploc skykey commands
...
// testDeleteKey tests that deleting a Skykey by name or id actually deletes
// the key
