...
For example: uploc gateway blocklist append 123.123.123.123 111.222.111.222 myuplohost.duckdns.org`,
	...
	For example: uploc gateway blocklist clear`,
...
For example: uploc gateway blocklist remove 123.123.123.123 111.222.111.222 myuplohost.duckdns.org`,
...
For example: uploc gateway blocklist set 123.123.123.123 111.222.111.222 myuplohost.duckdns.org`,
...
// gatewayconnectcmd is the handler for the command `uploc gateway add [address]`.
...
// gatewaydisconnectcmd is the handler for the command `uploc gateway remove [address]`.
...
// gatewayaddresscmd is the handler for the command `uploc gateway address`.
...
//gatewaybandwidthcmd is the handler for the command `uploc gateway bandwidth`.
...
// gatewaycmd is the handler for the command `uploc gateway`.
...
// gatewayblocklistcmd is the handler for the command `uploc gateway blocklist`
...
// `uploc gateway blocklist append`
...
// `uploc gateway blocklist remove`
...
// gatewaylistcmd is the handler for the command `uploc gateway list`.
...
// gatewayratelimitcmd is the handler for the command `uploc gateway ratelimit`.
