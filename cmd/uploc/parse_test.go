...
func TestCurrencyUnits(t *testing.T) {
	tests := []struct {
		...
		{"1000000000000000000000000", "1 UC"},
...
func TestCurrencyUnitsWithExchangeRate(t *testing.T) {
	tests := []struct {
		...
		{"1", "", "1 H"},
		{"1000000000000000000000", "n/a", "1 mU"},
		{"1000000000000000000000000", "---", "1 UC"},
		{"1000000000000000000000000000", "", "1 KU"},
		{"1000000000000000000000000", "1 USD", "1 UC (~ 1.00 USD)"},
		{"100000000000000000000000", "1 EUR", "100 mU (~ 0.10 EUR)"},
		{"10000000000000000000000", "10 EUR", "10 mU (~ 0.10 EUR)"},
		{"1000000000000000000000000000", "0.0039 USD", "1 KU (~ 3.90 USD)"},
	}
	for _, test := range tests {
